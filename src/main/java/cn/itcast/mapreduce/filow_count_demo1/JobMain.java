...
import cn.itcast.mapreduce.combiner.WordCountMap;
...
public class JobMain extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        TextInputFormat.addInputPath(job,new Path("file:///E:\\mapreduce\\input\\flowcount_input"));
        //第二步:设置我们的mapper类
        ...
        TextOutputFormat.setOutputPath(job,new Path("file:///E:\\flowcount_input"));
       //等待任务结束
