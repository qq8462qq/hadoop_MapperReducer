...
public class JobMain extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        TextInputFormat.addInputPath(job,new Path("file:///E:\\flowcount_input"));
        //第二步:设置我们的mapper类
        job.setMapperClass(FlowSortMapper.class);
        //设置我们map阶段完成之后的输出类型
        job.setMapOutputKeyClass(FlowBean.class);//k2类型
        ...
        TextOutputFormat.setOutputPath(job,new Path("file:///E:\\flowsort_input"));
       //等待任务结束
